...
export default function NoteList({ storyId, onNoteSelect }: NoteListProps) {
    ...
    // Note list content (shared between mobile and desktop)
    ...
    // Mobile layout (used inside Sheet)
    if (isMobile) {
        return (
            <>
    ...
    return (
        <>
            <div className={cn(
                "relative border-r border-input bg-background transition-all duration-300 flex flex-col",
